    ...
    <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Binary Search Strategy</h2>
          <p className="text-gray-600">Watch the computer efficiently find the number {targetNumber}</p>
        </div>
